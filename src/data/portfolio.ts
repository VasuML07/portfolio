  ...
  codingPlatforms: [
    {
      name: "GitHub",
      username: "VasuML07",
      url: "https://github.com/VasuML07",
      icon: "Github",
    },
    {
      name: "LeetCode",
      username: "coder_2028",
      url: "https://leetcode.com/u/coder_2028",
      icon: "Code",
    },
    {
      name: "Codeforces",
      username: "VasuML07",
      url: "https://codeforces.com/profile/VasuML07",
      icon: "Swords",
    },
    {
      name: "HackerRank",
      username: "coder_2028",
      url: "https://www.hackerrank.com/coder_2028",
      icon: "Award",
    },
    {
      name: "GeeksforGeeks",
      username: "vasumargana",
      url: "https://www.geeksforgeeks.org/user/vasumargana",
      icon: "BookOpen",
    },
    {
      name: "Kaggle",
      username: "VasuML07",
      url: "https://www.kaggle.com/vasuml07",
      icon: "BarChart3",
    },
  ],
  ...
  experiments: [
    {
      ...
      description:
        "Interactive visualization of optimization algorithms navigating loss surfaces. Compares SGD, Momentum, and Adam on 2D convex and non-convex functions.",
      tags: ["Optimization", "Visualization"],
    },
    {
      title: "Neural Network Playground",
      description:
        "Build small networks in the browser, adjust architecture and hyperparameters, observe how decision boundaries evolve during training in real time.",
      tags: ["Deep Learning", "Interactive"],
    },
    {
      title: "Sorting Algorithm Visualizer",
      description:
        "Side-by-side comparison of sorting algorithms with step-by-step execution. Useful for building intuition about time complexity.",
      tags: ["Algorithms", "Visualization"],
    },
    {
      title: "Markov Chain Text Generator",
      description:
        "Train character-level and word-level Markov models on any text input. Explore how chain length affects output coherence.",
